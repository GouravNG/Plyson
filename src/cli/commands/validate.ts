...
export const validateCommand = new Command('validate')
  ...
  .option('-t, --type <type>', 'Target specific categories: project, suite, script, handler, env, var')
  ...
  .action(async (targetPath, options) => {
    ...
    try {
      if (options.repair) {
        ...
        const effectiveRoot = existsSync(targetPath) && (await fs.stat(targetPath)).isDirectory() 
          ? targetPath 
          : rootDir;
