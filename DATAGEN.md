...
`play-son` provides a powerful dual-system for handling dynamic data: **Variable Interpolation** for reusing values and **Dynamic Generators** (backed by Faker.js) for creating fresh data on the fly.
