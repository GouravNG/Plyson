...
Now that you understand the [Project Structure](/docs/getting-started/project-structure), let's dive into writing your first test. Plyson tests are defined in JSON, which means they are purely declarative and easy to maintain.
