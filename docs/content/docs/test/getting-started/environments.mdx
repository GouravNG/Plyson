...
Environment files are stored in the `environments/` directory and follow the `*.env.json` naming convention. For a detailed breakdown of all available fields, see the [Environments Reference](/docs/json-reference/environments).
